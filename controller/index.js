...
const product = require('./product');const user_route = require('./user'); const cart_route = require('./cart')
const mongoose = require("mongoose");
const {Product_schema} = require('../data/mongo')
controller.use(product);controller.use(user_route) ; controller.use(cart_route)
